...
# Bu kolonlar korelasyon filtresinden MUAF tutulur —
# feature_engineering_fixed.py'daki alan bilgisi ozelliklerinin hesaplanmasi icin zorunludur.
# Bu kolonlar korelasyon filtresinden MUAF tutulur —
# feature_engineering_fixed.py'daki alan bilgisi ozelliklerinin hesaplanmasi icin zorunludur.
PROTECTED_COLS = [
    ...
    'Bwd IAT Total',                # djit
    'Fwd IAT Std',                  # sjit proxy
    'Bwd Packets/s',                # bwd_pkt_rate (dpkts fallback)
]
